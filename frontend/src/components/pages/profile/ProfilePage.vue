      ...
      <div class="profile-header">
        ...
        <div v-if="isOwnProfile && isAdmin" class="admin-section">
          <h3 class="admin-section-title">
            <svg class="admin-section-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            ...
            <div class="game-info">
              ...
              <div class="game-details">
                <div class="game-time">
                  <svg class="game-time-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
