      ...
      <div class="faq-content">
        ...
        <section class="faq-section">
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>Рейтинг начисляется только за игры на достаточно сложных полях (минимум 10×10 с определенным количеством мин). Чем быстрее вы решите поле и чем сложнее оно было, тем больше рейтинга вы получите.</p>
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>Рейтинг начисляется только за игры на полях достаточной сложности. Маленькие поля (например, 5×5 или 6×5) считаются слишком простыми и не дают рейтинга. Для получения рейтинга создавайте или присоединяйтесь к комнатам с более сложными настройками.</p>
            </div>
          </div>
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              ...
              <ul>
                ...
                <li>Процент побед</li>
                <li>Топ-10 лучших игр с начисленным рейтингом</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section class="faq-section">
          ...
          <div class="faq-item">
            <h3 class="faq-question">Что такое курсоры других игроков?</h3>
            <div class="faq-answer">
              <p>Когда другие игроки находятся в той же комнате, вы видите их курсоры на игровом поле. Это помогает понимать, где находятся другие игроки и что они делают. При наведении на курсор вы увидите никнейм игрока.</p>
            </div>
          </div>
        </section>
        ...
        <section class="faq-section">
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>В каждой игре у вас есть 3 подсказки. Подсказка открывает случайную безопасную ячейку. Используйте их с умом, когда застряли!</p>
            </div>
          </div>
        ...
        <section class="faq-section">
          ...
          <div class="faq-item">
            ...
            <div class="faq-answer">
              <p>Если у вас возникли проблемы или вопросы, которые не освещены в этом FAQ, пожалуйста, сообщите об этом через форму обратной связи или напишите разработчикам.</p>
            </div>
          </div>
        </section>
      </div>
