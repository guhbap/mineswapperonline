...
const adjectivesMasculine = [
  'зеленый', 'быстрый', 'тихий', 'яркий', 'смелый', 'умный', 'горячий', 'холодный',
  'большой', 'маленький', 'новый', 'старый', 'красный', 'синий', 'желтый', 'белый',
  'черный', 'фиолетовый', 'оранжевый', 'розовый', 'золотой', 'серебряный', 'медный',
  'железный', 'деревянный', 'каменный', 'стеклянный', 'пластиковый', 'металлический',
  'мягкий', 'твердый', 'гладкий', 'шершавый', 'острый', 'тупой', 'легкий', 'тяжелый',
  'высокий', 'низкий', 'широкий', 'узкий', 'длинный', 'короткий', 'толстый', 'тонкий',
  'круглый', 'квадратный', 'треугольный', 'прямой', 'кривой', 'ровный', 'неровный',
  'чистый', 'грязный', 'светлый', 'темный', 'тусклый', 'блестящий', 'матовый',
  'шумный', 'громкий', 'медленный', 'активный', 'ленивый',
  'веселый', 'грустный', 'радостный', 'серьезный', 'смешной', 'страшный', 'красивый', 'уродливый'
]
...
const nounsWithGender: Array<[string, 'm' | 'f' | 'n']> = [
  // Мужской род
  ['ромб', 'm'], ['ковёр', 'm'], ['стол', 'm'], ['стул', 'm'], ['дом', 'm'], ['дождь', 'm'],
  ['снег', 'm'], ['ветер', 'm'], ['огонь', 'm'], ['камень', 'm'], ['корень', 'm'], ['плод', 'm'],
  ['меч', 'm'], ['щит', 'm'], ['шлем', 'm'], ['лук', 'm'], ['копье', 'm'], ['топор', 'm'],
  ['молот', 'm'], ['корабль', 'm'], ['парус', 'm'], ['якорь', 'm'], ['руль', 'm'], ['флаг', 'm'],
  ['план', 'm'], ['ответ', 'm'], ['путь', 'm'], ['мост', 'm'], ['остров', 'm'], ['прилив', 'm'],
  ['холм', 'm'], ['лес', 'm'], ['сад', 'm'], ['парк', 'm'], ['зверь', 'm'],

  // Женский род
  ['дверь', 'f'], ['стена', 'f'], ['книга', 'f'], ['ручка', 'f'], ['бумага', 'f'], ['звезда', 'f'],
  ['луна', 'f'], ['вода', 'f'], ['земля', 'f'], ['трава', 'f'], ['ветка', 'f'], ['птица', 'f'],
  ['рыба', 'f'], ['собака', 'f'], ['кошка', 'f'], ['лошадь', 'f'], ['корова', 'f'], ['овца', 'f'],
  ['коза', 'f'], ['кольчуга', 'f'], ['стрела', 'f'], ['лодка', 'f'], ['мачта', 'f'], ['палуба', 'f'],
  ['каюта', 'f'], ['мечта', 'f'], ['мысль', 'f'], ['идея', 'f'], ['цель', 'f'], ['задача', 'f'],
  ['проблема', 'f'], ['дорога', 'f'], ['тропа', 'f'], ['тропинка', 'f'], ['тропка', 'f'],
  ['аллея', 'f'], ['улица', 'f'], ['площадь', 'f'], ['река', 'f'], ['волна', 'f'], ['гора', 'f'],
  ['долина', 'f'], ['роща', 'f'], ['поляна', 'f'], ['фраза', 'f'],

  // Средний род
  ['окно', 'n'], ['пол', 'n'], ['потолок', 'n'], ['слово', 'n'], ['письмо', 'n'], ['солнце', 'n'],
  ['облако', 'n'], ['дерево', 'n'], ['цветок', 'n'], ['лист', 'n'], ['семя', 'n'], ['решение', 'n'],
  ['сквер', 'n'], ['озеро', 'n'], ['море', 'n'], ['берег', 'n'], ['поле', 'n'], ['луг', 'n'],
  ['конверт', 'm'] // конверт - мужской род
]
